...
<head>
    ...
    <link rel="stylesheet" href="estilos.css?43254">
...
<div class="registrar-form" id="fr-rg">
    ...
    <input type="text" id="users" placeholder="INGRESA TU USUARIO">
    <input type="password" id="passe" placeholder="INGRESA TU PASSWORD">
    <input type="button" value="REGISTRAR" onclick="validarg()">
</div>

<div class="login-form" id="fr-lg">
    <h1 class="login-titu">INICIAR SESION</h1>
    <input type="text" id="user-l" placeholder="INGRESA TU USUARIO">
    <input type="password" id="pass-l" placeholder="INGRESA TU PASSWORD">
...
<!--termino de formulario-->
    ...
    <script src="javascript/app_login.js?4153"></script>
    <script src="javascript/login-register.js?2243"></script>
    <script src="javascript/app_register.js?784563"></script>
